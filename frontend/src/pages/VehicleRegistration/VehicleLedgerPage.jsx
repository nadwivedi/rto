...
const VehicleLedgerPage = () => {
  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-gray-50 via-purple-50 to-pink-50 flex flex-col'>
      ...
      {/* ── Sticky Grand Footer Balance Bar ── */}
      {!loading && !error && allWork.length > 0 && (
        <div className={`mt-auto sticky bottom-0 border-t bg-white px-6 py-4 shadow-[0_-4px_12px_rgba(0,0,0,0.05)] z-10`}>
          <div className='max-w-6xl mx-auto w-full flex items-center justify-between gap-6'>
            <div className='flex items-center gap-3'>
              {hasPendingBalance ? (
                <>
                  <div className='w-10 h-10 rounded-xl bg-red-50 flex items-center justify-center border border-red-100 flex-shrink-0 animate-pulse'>
                  ...
                  <div>
                    ...
                    <p className='text-xs text-red-500'>Outstanding payment pending on this vehicle.</p>
                  </div>
                </>
              ) : (
                <>
                  ...
                  <div>
                    <p className='text-sm font-bold text-emerald-800'>All Cleared</p>
                    <p className='text-xs text-emerald-600'>Excellent! No pending ledger balance outstanding.</p>
                  </div>
                </>
              )}
            </div>
            ...
            <div className='text-right'>
              <p className='text-[10px] font-semibold text-gray-400 uppercase tracking-wider'>Total Pending Balance</p>
