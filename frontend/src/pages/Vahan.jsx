...
const PermitTypeSelectModal = ({ onClose, openModal }) => {
  ...
  const options = [
    ...
    { id: 'Add State Permit', label: 'Add State Permit', icon: 'M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z', colorClass: 'text-green-700 bg-green-50 border-green-200 hover:bg-green-100 ring-green-400' },
...
const Vahan = () => {
  ...
  const quickAddModals = {
    ...
    'Add NP': 'Add NP',
    'Add State Permit': 'Add State Permit',
      ...
      <aside className={`fixed top-0 left-0 h-full w-72 bg-slate-900 text-white z-[56] transition-transform duration-300 ease-in-out lg:hidden ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        <div className="flex flex-col h-full">
          <div className="p-6 border-b border-white/10 flex justify-between items-center">
            <h2 className="font-bold text-lg">Vahan Options</h2>
