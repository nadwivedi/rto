...
const greenTaxRoutes = require('./routes/greenTax')
const professionalTaxRoutes = require('./routes/professionalTax')
...
app.use('/api/green-tax', userAuth, greenTaxRoutes)
app.use('/api/professional-tax', userAuth, professionalTaxRoutes)
...
app.use('/api/agents', userAuth, agentRoutes)
app.use('/api/kyc', userAuth, kycRoutes)
app.use('/api/bookmarks', userAuth, bookmarkRoutes)
