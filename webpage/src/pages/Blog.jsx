            ...
            {blogs.map((blog) => (
              ...
              >
                <div className='h-48 bg-gradient-to-br from-indigo-100 to-purple-100 flex items-center justify-center overflow-hidden'>
                  {blog.coverImage ? (
                    <img src={blog.coverImage?.startsWith('/uploads') ? `${API_URL}${blog.coverImage}` : blog.coverImage} alt={blog.title} className='w-full h-full object-cover group-hover:scale-105 transition-transform duration-500' />
                  ) : (
